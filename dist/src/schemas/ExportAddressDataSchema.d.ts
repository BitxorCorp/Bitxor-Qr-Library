 ...
 */
import { QRCodeDataSchema } from '../../index';
 ...
 * @since 0.3.0
 */
declare class ExportAddressDataSchema extends QRCodeDataSchema {
    constructor();
    /**
     ...
     */
    static parse(json: string): AddressQR;
}
