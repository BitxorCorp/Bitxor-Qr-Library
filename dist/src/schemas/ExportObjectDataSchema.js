 ...
 * @since 0.3.0
 */
var ExportObjectDataSchema = /** @class */ (function (_super) {
    __extends(ExportObjectDataSchema, _super);
    function ExportObjectDataSchema() {
     ...
     * @return {any}
     */
    ExportObjectDataSchema.prototype.getData = function (qr) {
        return qr.object;
    };
    /**
     ...
     */
    ExportObjectDataSchema.parse = function (json) {
        if (!json.length) {
            throw Error('JSON argument cannot be empty.');
        }
        var jsonObj = JSON.parse(json);
        if (!jsonObj.type || jsonObj.type !== index_1.QRCodeType.ExportObject) {
        ...
        return new index_1.ObjectQR(obj, network, generationHash);
    };
    return ExportObjectDataSchema;
}(index_1.QRCodeDataSchema));
exports.ExportObjectDataSchema = ExportObjectDataSchema;
//# sourceMappingURL=ExportObjectDataSchema.js.map