...
describe('AccountQR -->', () => {
    ...
    describe('fromJSON() should', () => {
        ...
        it('reconstruct contact given AddressQR JSON', () => {
            ...
            // Act:
            const exportContact = new AddressQR('bitxorcorp', address.plain(), NetworkType.TEST_NET, 'no-chain-id');
            const importContact = AddressQR.fromJSON(exportContact.toJSON());

            // Assert
            expect(importContact.name).to.be.equal('bitxorcorp');
        ...
        it('reconstruct contact given correct JSON structure', () => {
            ...
            // Assert
            expect(addressQR.name).to.be.equal('bitxorcorp');
