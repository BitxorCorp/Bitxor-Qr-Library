# Contributing to bitxorcorp-qr-library

First off, thank you for considering contributing to bitxorcorp-qr-library.
It’s people like you that make bitxorcorp-qr-library such a great tool.

bitxorcorp-qr-library is an open source project and we love to receive contributions from
...
writing code which can be incorporated into bitxorcorp-qr-library itself.
...
If you think you have found a bug in bitxorcorp-qr-library, first make sure that you
are testing against the latest version of bitxorcorp-qr-library - your issue may already
...
If you find yourself wishing for a feature that doesn't exist in bitxorcorp-qr-library,
you are probably not alone. There are bound to be others out there with similar
needs. Many of the features that bitxorcorp-qr-library has today have been added because
our users saw the need. Open an [issue](github-issues) on our issues list on GitHub which describes
the feature you would like to see, why you need it, and how it should work.

## Contributing code and documentation changes

If you have a bugfix or new feature that you would like to contribute to bitxorcorp-qr-library, please find or open an issue
...
You will need to fork the main bitxorcorp-qr-library code repository and clone
...
Then sit back and wait. There will probably be discussion about the pull request and, if any changes are needed, we would love to work with you to get your pull request merged into bitxorcorp-qr-library.
...
[github-issues]:https://github.com/anthonylaw/bitxorcorp-qr-library/issues